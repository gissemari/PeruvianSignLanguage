...
python 4.Translation/FrameToKeypoint/ConvertVideoToDict.py --inputPath ./Data/AEC/Videos/Segmented_gestures/ --img_output ./Data/AEC/Dataset/img/  --dict_output ./Data/AEC/Dataset/dict/ --keypoints_output ./Data/AEC/Dataset/keypoints/
