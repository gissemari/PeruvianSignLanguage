...
folder = 'data/sign/train' # 'output_file_train', 'output_file_test'
npy_folder = 'data/npy3/train' # 'train_npy/npy3', 'test_npy/npy3'
out_folder = 'data/flow_depth/train' # 'train_flow_depth', 'test_flow_depth', 'train_flow_color', 'val_flow_color', 'test_flow_color' 
