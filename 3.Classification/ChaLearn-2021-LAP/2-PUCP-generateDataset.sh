...
python 5.Preparation/DictToSample.py --dict_Path ./Data/PUCP_PSL_DGI156/Dataset/dict/dict.json --shuffle --output_Path ./Data/PUCP_PSL_DGI156/Dataset/readyToRun/ --wor$
echo ""
