...
python 1.Preprocessing/Selector/DictToSample.py --dict_Path ./Data/PUCP_PSL_DGI156/dict.json --shuffle --output_Path ./Data/PUCP_PSL_DGI156/Selected/ --words $1 --words_File ./Data/stevList.csv
echo ""
