...
python 5.Preparation/DictToSample.py --dict_Path ./Data/AEC/Dataset/dict/dict.json --output_Path ./Data/AEC/Dataset/readyToRun/ --words_File ./Data/list.csv --words $1
echo ""
