#python predict.py --log_dir project/log --dataset handcrop_poseflow --num_workers 4 --sequence_length 15 --temporal_stride 1 --learning_rate 0.0001 --gradient_clip_val=1 --gpus 1 --cnn rn34 --num_layers 4 --num_heads 8 --batch_size 4 --accumulate_grad_batches 8 --data_dir project/data/mp4 --model VTN_HCPF --num_classes 10 --seed 22 --version chameleon_1 --csv_name marzo.csv --checkpoint osoPucp/checkpoints/bestLoggedModel.ckpt --submission_template data/test_labels.csv --out submission/predOutputs_chameleon_1.csv --subject pucpSubject.csv

python predict.py --checkpoint 'osoPucp/checkpoints/bestLoggedModel.ckpt'  --log_dir project/log --dataset handcrop_poseflow --submission_template data/test_labels.csv --out submission/predOutputsOsoPucp.csv --version 1 --subject pucpSubject.csv --seed 41 --num_workers 1 --sequence_length 15 --temporal_stride 1 --learning_rate 1e-4 --gradient_clip_val=1 --gpus 1 --cnn rn34 --num_layers 4 --num_heads 8 --batch_size 4 --accumulate_grad_batches 8 --data_dir project/data/mp4 --model VTN_HCPF  --num_classes 10 --csv_name summary.csv
