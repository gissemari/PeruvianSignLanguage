...
#60
python predict.py --log_dir project/log --dataset handcrop_poseflow --checkpoint 'project/log/VTN_HCPF/version_60/checkpoints/epoch=124-step=347.ckpt' --submission_template data/test_labels.csv --out predOutputs60.csv --subject pucpSubject.csv --num_workers 4 --sequence_length 15 --temporal_stride 2 --learning_rate 1e-4 --gradient_clip_val=1 --gpus 1 --cnn rn34 --num_layers 4 --num_heads 4 --batch_size 8 --accumulate_grad_batches 8 --data_dir project/data/mp4 --model VTN_HCPF --num_classes 10
