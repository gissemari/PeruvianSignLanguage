...
python 5.Preparation/DictToSample.py --dict_Path Data/AEC/Dataset/dict/dict.json --shuffle --output_Path Data/AEC/Dataset/readyToRun/ --words_File Data/list.csv --words 10
echo ""
