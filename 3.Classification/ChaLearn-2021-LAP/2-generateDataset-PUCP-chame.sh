echo ""
echo "generating data in Peruvian Sign language project for PUCP dataset"
sleep 1
cd ../..
cp -r utils 5.Preparation
python 5.Preparation/DictToSample.py --dict_Path Data/PUCP_PSL_DGI156/Dataset/dict/dict.json --shuffle --output_Path Data/PUCP_PSL_DGI156/Dataset/readyToRun/ --words_File Data/list10.csv --words 10
echo ""
