...
This script is used to process a video an save its frame with keypoints drawed using mediaPipe models:
- face_mesh
- pose
- hands

we currently do not use this model, but a holistic mediapipe model instead
that has all the mentioned models in one.

The script is also use to analise the following models:
- FaceMesh -> detect face
- Hand -> detect right hand or left hand
- Pose -> detect pose
