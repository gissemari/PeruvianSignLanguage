...
python 4.Translation/FrameToKeypoint/ConvertVideoToDict.py --inputPath /data/bejaranog/signLanguage/Data/PUCP_PSL_DGI156/Videos/SEGMENTED_SIGN/ --img_output ./Data/PUCP_PSL_DGI156/Dataset/img/  --dict_output /data/bejaranog/signLanguage/Data/PUCP_PSL_DGI156/Dataset/dict/ --keypoints_output /data/bejaranog/signLanguage/Data/PUCP_PSL_DGI156/Dataset/keypoints/
